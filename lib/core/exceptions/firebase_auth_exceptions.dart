class SignUpWithEmailAndPasswordFailure {
  ...
  factory SignUpWithEmailAndPasswordFailure.code(String code){
    switch(code){
      ...
      return const SignUpWithEmailAndPasswordFailure('An account already exist with this email.');
      ...
      default:
      return const SignUpWithEmailAndPasswordFailure("An Unknown error occured");
    }
  }
